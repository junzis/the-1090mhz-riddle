...
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Sub-type specific fields}\\ ~~Refer to Table \ref{tb:adsb-velocity-bits-14-35-gs} and Table \ref{tb:adsb-velocity-bits-14-35-as} \end{tabular} &  & \begin{tabular}[c]{@{}c@{}}46\\ :\\ 67\end{tabular} & \begin{tabular}[c]{@{}c@{}}14\\ :\\ 35\end{tabular} & 22 \\ \hline
\hline
...
\begin{tabular}[c]{@{}l@{}}\textbf{Difference between GNSS and Baro altitudes}\\ ~~All zeros: no information\\ ~~LSB: 25 ft\end{tabular} & DAlt & \begin{tabular}[c]{@{}c@{}}82\\ :\\ 88\end{tabular} & \begin{tabular}[c]{@{}c@{}}50\\ :\\ 56\end{tabular} & 7 \\ \hline
\end{tabular}
\end{table}
